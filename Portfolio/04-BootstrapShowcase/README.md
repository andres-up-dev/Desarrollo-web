...
In this exercise, you will build a high-fidelity responsive landing hero screen. The page must use:
1.  A responsive **Bootstrap Grid** that shifts columns between devices.
2.  A functional **Bootstrap Carousel** showcasing three key target metrics.
3.  Modular **Bootstrap Cards** highlighting community solution paths.          
4.  **Bootstrap Buttons** using semantic color tokens to represent priority actions.

#### 📦 Exercise Resources
*   **Pre-class Readings:** Bootstrap 5 Layout Grid Docs.
*   **Target Breakpoints to Enforce:**
    *   *Mobile (xs/sm < 768px):* Single column layout (full width).
    *   *Tablet (md < 992px):* Two-column split layout.
    *   *Desktop (lg+ ≥ 992px):* Multi-column grid.
...
Select 3 elements from the following list and make a small demo of how would you implement it in a project.
